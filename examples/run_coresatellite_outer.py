...
initial_volume = core_volume - inner_volume 
volume_fraction = 0.2
sst_0 = ((Qsst / N_A) / initial_volume) / volume_fraction * 1e15 * M
model.sst.initial = lambda nd: sst_0 if ((nd.x3d**2 + nd.y3d**2 + nd.z3d**2 < r_core**2) and (nd.x3d**2 + nd.y3d**2 + nd.z3d**2 > r_inner**2)) else 0
print('simulating...')

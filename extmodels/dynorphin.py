...
class Model(ModelBase):
    ...
    def __init__(
        ...
        # Modeling an initial uniform concentration within a disc that
        ...
        # Dynorphin concentration accounting for volume faction.
        dyn_0 = ((Qdyn / N_A) / disc_vol) / volume_fraction * 1e15 * M
        self._dyn_0 = dyn_0
